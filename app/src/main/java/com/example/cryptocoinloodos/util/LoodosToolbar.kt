package com.example.cryptocoinloodos.util
...
import com.example.cryptocoinloodos.databinding.LayoutToolbarBinding

class LoodosToolbar @JvmOverloads constructor(
    context: Context,
